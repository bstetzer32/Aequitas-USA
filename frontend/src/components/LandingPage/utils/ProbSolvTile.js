  ...
  return (
    <div className="prob-solv-tile">
      <div className="prob-solv-tile__info">
        <div className="prob-solv-tile__info__title">
          {type === "problem" ? (
            ...
            <SolvPageModal i={i} j={j} title={feed[i].solutions[j]?.title} />
          ) : null}
        </div>
        <Link
          to={`/regions/${
            type === "problem" ? feed[i].regionId : feed[i].regionId
          }`}
        >
      ...
      <div className="prob-solv-tile__img">
        {type !== "problem" ? (
          <img
            className="prob-solv-tile__img"
            alt="tile__img"
            src={info?.img ? info.img : "https://i.stack.imgur.com/y9DpT.jpg"}
          ></img>
        ) : (
          <img
            className="prob-solv-tile__img"
